...
private:
    ...
    std::unordered_map<std::string, double> ramp_start_;
    ...
    // Balance PD gains — conservative to avoid exciting contact resonances
    double kp_balance_pitch_ = 30.0;
    double kd_balance_pitch_ = 4.0;
    double kp_balance_roll_  = 15.0;
    double kd_balance_roll_  = 2.0;

    int  control_cycle_       = 0;
    bool ramp_start_captured_ = false;
    bool ramp_logged_         = false;
    bool balance_logged_      = false;
};
